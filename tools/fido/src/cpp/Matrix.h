...
public:
  ...
  class NonSquareMatrixException :public exception {
   ...
   {
    return "matrix: non square matrix exception";
   }
  };
  class SizeException :public exception{
   virtual const char* what() const throw()
   {
    return "matrix: size exception";
   }
  };
  ...
  class MatrixFormatException :public exception{
   virtual const char* what() const throw()
   {
    return "matrix: format exception";
   }
  };
  class MatrixIntegrityException :public exception{
   virtual const char* what() const throw()
   {
    return "matrix: integrity exception";
   }
  };
  class SingularMatrixException :public exception{
   virtual const char* what() const throw()
   {
    return "matrix: singular matrix exception";
   }
  };
