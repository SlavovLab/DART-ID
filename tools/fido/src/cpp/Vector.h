...
public:
 ...
 explicit Vector(int N) :
  ...
  virtual const char* what() const throw()
   {
    return "vector: singular matrix exception";
   }
  };
  ...
  class VectorIntegrityException :public exception{
   virtual const char* what() const throw()
   {
    return "vector: singular matrix exception";
   }
  ...
  class VectorInverseException :public exception{
	virtual const char* what() const throw()
    {
    return "vector: singular matrix exception";
   }
  ...
  class SmallEmbedException :public exception{
  virtual const char* what() const throw()
   {
    return "vector: singular matrix exception";
   }
  ...
  class VectorIndexOfOfBoundsException :public exception{
  virtual const char* what() const throw()
   {
    return "vector: singular matrix exception";
   }
