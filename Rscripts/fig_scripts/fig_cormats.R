...
pdf(file='manuscript/Figs/cormats_type_v3.pdf', width=4.5, height=3.5)
...
mtext(paste0('Spectra'), side=1, line=3.75, cex=1, font=2)
...
mtext(paste0('DART-ID'), side=1, line=3.75, cex=1, font=2)
